...
#[ORM\Table(name: 'user', schema: 'admin')]
#[ORM\UniqueConstraint(name: 'UNIQ_USER_EMAIL_OWNER', fields: ['email'])]
#[ORM\UniqueConstraint(name: 'UNIQ_USER_PHONE_OWNER', fields: ['phone'])]
