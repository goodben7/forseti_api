...
class UserManager
{
    ...
    public function createUserFromOtp(string $phone, ?Profile $profile = null): User
    {
        try {
            $user = new User();
            $user->setPhone($phone);
            ...
            throw new UnavailableDataException('Error creating new user from OTP: ' . $e->getMessage());
        }
    }
